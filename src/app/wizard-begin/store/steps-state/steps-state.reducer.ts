...
export function stepsBeginReducer(state: IStepsState, action: Action): IStepsState {
    ...
    switch (action.type) {
        ...
        case StepsStateStore.RETRIEVE_SUCCESS:
            console.log('steps-begin.reducer found match StepsStateStore.RETRIEVE_SUCCESS');
            return {
                ...state,
                isLoading: false,
        ...
        case StepsStateStore.STATECHANGED:
            console.log('steps-begin.reducer StepsStateStore.STATECHANGED', action.payload);
            ...
            let obj = Object.assign({}, state, {
                ...
                stepStates: state.list.slice(0, idx).concat(new StepState(name, s.Value))
