...
@Component({
  selector: 'app-reference-item-detail-page',
  templateUrl: './item-detail-page.component.html',
  styleUrls: ['./item-detail-page.component.scss']
})
export class ReferenceDetailPageComponent implements OnInit, ErrorHandler {
  ...
  constructor(
    ...
    private listingStore: ReferenceListingStore,
  ) {
  }
